...
let GameData = {
    ...
    showRightAnswerModal1: false,

    showRightAnswerModal2: false,
    showWrongAnswerModal2: false,
    ...
    canClickWordPanels: () => {
        return GameData.showWrongAnswerModal1 === false &&
               GameData.showRightAnswerModal1 === false &&
               GameData.showRightAnswerModal2 === false && 
               GameData.showWrongAnswerModal2 === false && 
               ...
               GameData.showWrongAnswerModal5 === false && 
...
class ContinueButton extends Image {
    ...
    Tick(){
        this.HoverTransformScale(GameData);
        this.OnClick(this.GoToLink(GameData, "../scene_25"), GameData)
    }
}

class RestartButton extends Image {
    constructor(game, width, height, x, y, speed, image){
        super(game, width, height, x, y, speed, image);
    }
    ...
    Tick(){
        this.HoverTransformScale(GameData);
        this.OnClick(this.GoToLink(GameData, "/"), GameData)
    }
}
...
class WordPanel1 {
    ...
    draw(context, number) {
        ...
        renderTextTimer('Desenho', "#009966", this.width, this.textX * 1);
    }
...
class WordPanel2 {
    ...
    draw(context, number) {
        ...
        renderTextTimer('Jogador', "#009966", this.width, this.textX * 1);
    }
    ...
    RenderModalAnswer(number, context){
        ...
        GameData.showWrongAnswerModal2 = true;
        GameData.showDoubtModal = false;
        GameData.Word2Visible = false;
...
class WordPanel3 {
    ...
    draw(context, number) {
        ...
        renderTextTimer('Soneca', "#009966", this.width, this.textX * 1);
    }
...
class WordPanel4 {
    ...
    constructor(game, number){
        ...
        const setAttributes = () => {
            ...
            this.imageError = document.getElementById("image_error");
            this.imageRight = document.getElementById("image_right");
            this.imageTheEnd = document.getElementById("image_the_end");
            this.modalBackground = document.getElementById("black_background");
            this.modalBackButton = document.getElementById("back_button");
            this.magicianPanel = document.getElementById("magician_panel");
            this.youPanel = document.getElementById("you_panel");
    ...
    draw(context, number) {
        ...
        renderTextTimer('Passado', "#009966", this.width, this.textX * 1);
    }
    ...
    RenderModalTheEnd(context){

        context.drawImage(this.modalBackground, 0, 0, window.innerWidth, window.innerHeight);
        context.drawImage(this.imageTheEnd, (window.innerWidth * 0.5) - this.width, (window.innerHeight * 0.1), (window.innerWidth * 0.5), (window.innerWidth * 0.5) * 0.3 );
...
class WordPanel5 {
    ...
    draw(context, number) {
        ...
        renderTextTimer('Limparam', "#009966", this.width, this.textX * 1);
    }
...
class Game {
    constructor(canvas){
        ...
        this.RestartButton = new RestartButton(this, window.innerWidth * 0.2, (window.innerWidth * 0.1) * 0.5, window.innerWidth * 0.78, window.innerHeight * 0.70, 2, GameData.restartButton )
    ...
    render(context){
        ...
        if (GameData.showWrongAnswerModal2) {

            if(this.Word2.MagicianPointAdded === false){
                GameData.magicianPoints += 5;
                this.Word2.MagicianPointAdded = true;
            }
