...
class BaloonTalk {
    constructor(game){
        this.game = game;
        this.image = document.getElementById("baloon_talk")
...
class Game {
    constructor(canvas){
        ...
        this.BaloonTalk = new BaloonTalk(this)
    ...
    render(context){
        ...
        this.BaloonTalk.draw(context);
        this.BaloonTalk.tick();
...
const BeginPlay = () => {
    ...
    window.addEventListener('load', ()=>{
        ...
        hover_on_element(continue_button_hover, canvas, "../scene_3/");
        hover_on_element(back_button_hover, canvas, "../scene_1")
